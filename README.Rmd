...
library(jpeg);
img <- readJPEG('C:/WORK_FOLDERS_BGR/26_climada_root_2016_coastal_hazards/climada_coastal_hazards_module/code/ex_waves.jpg')
...
```{r, echo = F, message=FALSE, warning=FALSE}
library(jpeg);
img <- readJPEG('C:/WORK_FOLDERS_BGR/26_climada_root_2016_coastal_hazards/climada_coastal_hazards_module/code/waterfall_ex.jpg')
plot(1:2, type='n',axes=FALSE,ylab='',xlab='')
rasterImage(img,1,1,2,2)
```
