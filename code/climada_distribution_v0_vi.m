...
if check_visible
    ...
    subaxis(2,1,1,'sv',0.12,'ml',0.14)
        ...
        legend('Hist. data',['Normal fit, \mu = ' num2str(mu(1),'%10.2f')  ', \sigma = ' num2str(sigma(1),'%10.2f')],'location','ne')
        legend('boxoff')
    ...
    subaxis(2)
        ...
        legend('Hist. data',['Normal fit, \mu = ' num2str(mu(2),'%10.2f')  ', \sigma = ' num2str(sigma(2),'%10.2f')],'location','ne')
        legend('boxoff')
