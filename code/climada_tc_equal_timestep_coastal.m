function tc_track=climada_tc_equal_timestep_coastal(tc_track,default_min_TimeStep)
...
%     tc_track(track_i).lat=interp1(datenum_source,tc_track(track_i).lat,datenum_target,'linear','extrap');
    ...
    tc_track(track_i).onLand = interp1(datenum_source,tc_track(track_i).onLand,datenum_target,'nearest');
